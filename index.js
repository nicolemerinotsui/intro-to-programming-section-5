...
function checkGuess() {
  ...
  //line 30-34 added, line 34 placed in brackets, remove if needed
  if (guess <= 0) {
   negativeNumberMessage.style.display = '';
   negativeNumberMessage.innerHTML = `You made ${negative-message} guesses`;
  }
  else if (guess >= 100) {
...
//When number of attempted guesses = 4, display a new message that says "You have one guess remaining"
